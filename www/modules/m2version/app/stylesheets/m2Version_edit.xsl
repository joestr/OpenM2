...
-->
    ...
    <xsl:template match="/OBJECT">
        ...
        <xsl:if test="not (boolean(OBJECT/SYSTEM/@DISPLAY))">
            <xsl:call-template name="createSystemInfoRows"/>
            <BR/>
        </xsl:if>
<!-- KR 20051007 specific attributes not relevant for editing.
...
return true;
     ...
     *-->
    <xsl:template name="createSystemInfoRows">
...
<!-- KR 20051007 extended attributes not relevant for edit.
...
-->
    </xsl:template> <!-- createSystemInfoRows -->
