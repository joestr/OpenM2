 ...
 *
 * Description: This file creates the locale de_AT.
 *
 * Repeatable:  no
 *
 * @version     $Id: createLocale_de_AT.sql,v 1.1 2011/10/18 14:23:53 btatzmann Exp $
 *
...
--*****************************************************************************
    ...
    -- cleanup
    UPDATE ibs_object set state = 1 where name like 'de_AT'
	...
	BEGIN
		...
		-- create key mapper for locale de_AT:
		...
		EXEC @l_retVal = p_Locale_01$change @l_localeOid_s, @l_admin, 0,
			'de_AT', N'#CONFVAR.ibsbase.validUntil#', '', 1, 'de', 'AT', 0
