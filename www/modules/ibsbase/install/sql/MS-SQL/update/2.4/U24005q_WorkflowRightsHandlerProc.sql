 ...
 *
 * @version     $Id: U24005q_WorkflowRightsHandlerProc.sql,v 1.1 2005/02/15 21:30:41 klaus Exp $
 *
...
(
    -- common input parameters:
    @ai_oid1_s           OBJECTIDSTRING,
    @ai_oid2_s           OBJECTIDSTRING
)
AS
DECLARE
    -- constants:
...
-- body:
    -- convert oids
    EXEC p_stringToByte @ai_oid1_s, @l_oid1 OUTPUT
    EXEC p_stringToByte @ai_oid2_s, @l_oid2 OUTPUT
