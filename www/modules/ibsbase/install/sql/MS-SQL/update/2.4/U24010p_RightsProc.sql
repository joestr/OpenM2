 ...
 *
 * @version     $Id: U24010p_RightsProc.sql,v 1.1 2005/03/07 15:57:16 klaus Exp $
 *
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Rights$checkRKeyRights'
GO
...
-- body:
    ...
    BEGIN
        ...
        BEGIN
            ...
            INSERT INTO ibs_RightsKey
                    (rKeysId, owner, cnt)
            SELECT  actrk.rKeysId, @l_owner, actrk.cnt
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Rights$setKeyForAllRec'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Rights$propagateRightsRec'
GO
