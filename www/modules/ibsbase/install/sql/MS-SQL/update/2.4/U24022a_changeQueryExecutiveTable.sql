/******************************************************************************
 * Task:        TASK HIR01_02 - Search dialog within menu bar.
 *
 * Description: To enable search dialogs within menu bars the QueryExecutive
 *              is expanded with the ability to display the search form to
 *              allow the user to change search parameters.
 *
 * Repeatable:  yes
 *
 * @version     $Id: U24022a_changeQueryExecutiveTable.sql,v 1.1 2006/01/27 17:18:10 klreimue Exp $
 *
 * @author      Klaus Reimüller (KR) 20060122
 ******************************************************************************
 */ 
...
-- create the table:
CREATE TABLE tmp_ibs_QueryExecutive_01
(
...
SELECT
    @l_file = 'U24022a',
    @l_error = 0,
    @l_tableName = 'ibs_QueryExecutive_01',
    @l_tempTableName = 'tmp_ibs_QueryExecutive_01'
