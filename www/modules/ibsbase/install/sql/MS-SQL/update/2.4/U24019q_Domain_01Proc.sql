 ...
 *
 * @version     $Id: U24019q_Domain_01Proc.sql,v 1.1 2005/08/22 15:24:50 klaus Exp $
 *
...
EXEC p_dropProc 'p_Domain_01$create'
GO
...
-- body:
    BEGIN TRANSACTION
        ...
        BEGIN
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domAdmin', @l_name OUTPUT, @l_desc OUTPUT
            EXEC p_User_01$new @l_domainId, 0, @l_name, 'isEnc_K3QjSG5haSBtcGRMLmFBWQ%3D%3D%0A',
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domPublic', @l_name OUTPUT, @l_desc OUTPUT
            ...
            EXEC p_KeyMapper$new @l_public_s, 'menuPublic', 'ibs_instobj'
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domUserMmt', @l_name OUTPUT, @l_desc OUTPUT
            ...
            EXEC p_KeyMapper$new @l_userMmtOid_s, 'userAdmin', 'ibs_instobj'
            ...
            EXEC p_KeyMapper$new @l_groupContainer_s, 'groups', 'ibs_instobj'
            ...
            EXEC p_KeyMapper$new @l_userContainer_s, 'users', 'ibs_instobj'

            -- create group for all users:
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domGroupAll', @l_name OUTPUT, @l_desc OUTPUT
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domGroupAdministrators', @l_name OUTPUT, @l_desc OUTPUT
            EXEC @l_retValue = p_Group_01$create @l_admin, @l_localOp, 0x010100b1,
                @l_name, @l_groupContainer_s, 1, 0, @c_NOOID_s, @l_desc,
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domGroupUserGroupAdmins', @l_name OUTPUT, @l_desc OUTPUT
            EXEC @l_retValue = p_Group_01$create @l_admin, @l_localOp, 0x010100b1,
                @l_name, @l_groupContainer_s, 1, 0, @c_NOOID_s, @l_desc,
...
*/
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domGroupStructAdmins', @l_name OUTPUT, @l_desc OUTPUT
            EXEC @l_retValue = p_Group_01$create @l_admin, @l_localOp, 0x010100b1,
                @l_name, @l_groupContainer_s, 1, 0, @c_NOOID_s, @l_desc,
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domWorkspaces', @l_name OUTPUT, @l_desc OUTPUT
            ...
            EXEC p_KeyMapper$new @l_workspaces_s, 'userWorkspaces', 'ibs_instobj'
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domLayouts', @l_name OUTPUT, @l_desc OUTPUT
            ...
            EXEC p_KeyMapper$new @l_layoutContainerOid_s, 'layouts', 'ibs_instobj'
            ...
            -- container:
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domLayoutStandard', @l_name OUTPUT, @l_desc OUTPUT
            ...
            EXEC @l_retValue = p_Layout_01$change @l_layoutOid_s, @l_admin, 0,
                'Standard', '#CONFVAR.ibsbase.validUntil#', @l_desc, 1, 1
            ...
            EXEC p_ObjectDesc_01$get    @c_languageId, 'OD_domMenuTabs',
            ...
            EXEC p_KeyMapper$new @l_menutabContainerOid_s, 'menutabs', 'ibs_instobj'
            ...
            --**********************************************************************
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domPublic',
                                @l_name OUTPUT, @l_desc OUTPUT
            ...
            EXEC p_KeyMapper$new @l_menutabOid_s, 'menutabPublic', 'ibs_instobj'
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_wspPrivate',
                    @l_name OUTPUT, @l_desc OUTPUT
            ...
            EXEC p_User_01$createFast @l_admin, @l_domainId, @l_systemUserName,
                'isEnc_K3QjSHNhbyB0cG5MLmFpWQ%3D%3D%0A', @l_systemUserName, @l_systemUserOid OUTPUT
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domWorkspaceTemplate', @l_name OUTPUT, @l_desc OUTPUT
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Domain_01$setScheme'
GO
...
-- body:
    ...
    BEGIN
        ...
        -- Data Interchange:
        EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domDataInterchange', @l_name OUTPUT, @l_desc OUTPUT
        ...
        EXEC p_KeyMapper$new @l_cid_s, 'di', 'ibs_instobj'
        ...
        -- Import
        EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domDIImport', @l_name OUTPUT, @l_desc OUTPUT
        ...
        EXEC p_KeyMapper$new @l_oid_s, 'diimport', 'ibs_instobj'

        -- Export
        EXEC p_ObjectDesc_01$get @c_languageId, 'OD_domDIExport', @l_name OUTPUT, @l_desc OUTPUT
        EXEC p_Object$create @l_admin, @l_localOp, 0x01017a01, -- Export Container
                @l_name, @l_cid_s, 1, 0, @c_NOOID_s, @l_desc, @l_oid_s OUTPUT

        -- create key mapper for export container:
        EXEC p_KeyMapper$new @l_oid_s, 'diexport', 'ibs_instobj'
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Domain_01$change'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Domain_01$retrieve'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Domain_01$delete'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Domain_01$BOCopy'
GO
