...
PRINT 'starting U320005p_XMLViewer_01Proc.sql'
GO
...
EXEC p_dropProc N'p_XMLViewer_01$create'
GO
...
AS
    ...
    BEGIN TRANSACTION
        ...
        BEGIN
            SELECT @l_path = value + N'upload/files/'
	        FROM ibs_System
...
-- delete existing procedure:
EXEC p_dropProc N'p_XMLViewer_01$change'
GO
...
-- delete existing procedure:
EXEC p_dropProc N'p_XMLViewer_01$retrieve'
GO
...
-- delete existing procedure:
EXEC p_dropProc N'p_XMLViewer_01$delete'
GO
...
PRINT 'U320005p_XMLViewer_01Proc.sql finished'
GO
