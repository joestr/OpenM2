 ...
 *
 * @version     $Id: Domain_01Proc.sql,v 1.1 2010/02/25 13:53:47 btatzmann Exp $
 *
...
-- body:
    BEGIN TRANSACTION
        ...
        BEGIN
            ...
            EXEC p_User_01$new @l_domainId, 0, @l_name, N'isEnc_K3QjSG5haSBtcGRMLmFBWQ%3D%3D%0A',
...
*/
            ...
            EXEC p_User_01$createFast @l_admin, @l_domainId, @l_systemUserName,
                N'isEnc_K3QjSHNhbyB0cG5MLmFpWQ%3D%3D%0A', @l_systemUserName, @l_systemUserOid OUTPUT
