...
EXEC p_dropProc N'p_Translator_01$create'
GO

-- create the new procedure:
CREATE PROCEDURE p_Translator_01$create
(
...
*/
        -- create base object:
        EXEC @l_retValue = p_Attachment_01$create @ai_userId, @ai_op, @ai_tVersionId,
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Translator_01$change'
GO

-- create the new procedure:
CREATE PROCEDURE p_Translator_01$change
(
    -- common input parameters:
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Translator_01$retrieve'
GO

-- create the new procedure:
CREATE PROCEDURE p_Translator_01$retrieve
(
    -- input parameters:
    @ai_oid_s               OBJECTIDSTRING,
    @ai_userId              USERID,
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Translator_01$BOCopy'
GO

-- create the new procedure:
CREATE PROCEDURE p_Translator_01$BOCopy
(
    -- common input parameters:
    @ai_oid                 OBJECTID,
    @ai_userId              USERID,
    ...
    BEGIN TRANSACTION -- begin new TRANSACTION
        ...
        BEGIN
            ...
            EXEC @l_error = ibs_error.prepareError @@error,
                N'insert new edi translator data', @l_ePos OUTPUT
...
exception:                              -- an error occurred
    ...
    ROLLBACK TRANSACTION                -- undo changes
    -- log the error:
    EXEC ibs_error.logError 500, N'p_Translator_01$BOCopy', @l_error,
            @l_ePos,
            N'ai_userId', @ai_userId
    -- return error code:
    RETURN  @c_NOT_OK
GO
-- p_Translator_01$BOCopy
