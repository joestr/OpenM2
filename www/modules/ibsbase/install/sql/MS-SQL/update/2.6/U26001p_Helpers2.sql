 ...
 *
 * @version     $Id: U26001p_Helpers2.sql,v 1.2 2008/07/19 13:19:48 bbuchegger Exp $
 *
...
WHILE (@l_count > -1)
BEGIN
    SELECT @l_refOid_s = substring (@ai_refStr, @l_count * 19 + 1, 18)
	...
	SELECT @ao_valueStr = @ao_valueStr + ', ' + @l_value
END
