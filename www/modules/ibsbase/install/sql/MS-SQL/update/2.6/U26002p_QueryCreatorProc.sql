 ...
 * Search - Queries. <BR>
 *
 * @version     $Id: U26002p_QueryCreatorProc.sql,v 1.1 2008/07/17 12:11:17 bbuchegger Exp $
 *
...
EXEC p_dropProc 'p_QueryCreator_01$create'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_QueryCreator_01$change'
GO
-- create the new procedure:
...
-- delete existing procedure:
EXEC p_dropProc 'p_QueryCreator_01$retrieve'
GO
-- create the new procedure:
...
EXEC p_dropProc 'p_QueryCreator_01$BOCopy'
GO
-- create the new procedure:
