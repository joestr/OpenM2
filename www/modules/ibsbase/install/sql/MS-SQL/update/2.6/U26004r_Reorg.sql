 ...
 *
 *
 * @version     $Id: U26004r_Reorg.sql,v 1.1 2008/10/07 15:29:32 kreimueller Exp $
 *
    ...
    WHERE   o.type = 'U'
        ...
        AND o.name NOT IN
            (
                ...
                'ibs_Help_01',
                -- user management:
                'ibs_GroupUser', 'ibs_GroupUserCum', 'ibs_Workspace',
                -- domains:
...
-- body:
    ...
    -- special tables:
    EXEC p_reorgTable 'ibs_Workspace',
        'workspace NOT IN (SELECT oid FROM ibs_Object)'
