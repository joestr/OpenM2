    ...
    <xsl:template match="/OBJECT">
        ...
        <SCRIPT LANGUAGE="JavaScript">
            function xslSubmitAllowed()
            {
                ...
                purpose = document.sheetForm.<xsl:value-of select="VALUES/VALUE[@FIELD='Purpose']/@INPUT"/>.value;

                document.sheetForm.<xsl:value-of select="SYSTEM/NAME/@INPUT"/>.value = purpose;
