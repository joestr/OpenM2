 ...
 *
 * @version     $Id: createBaseQueryCreatorsProc.sql,v 1.1 2010/02/25 13:54:18 btatzmann Exp $
 *
...
-- company
    ...
    -- get token for additional searchfield
    EXEC p_Token_01$get @c_languageId, N'TOK_LEGALFORM', @l_tokSearchField OUTPUT, @l_typeClass OUTPUT
...
-- person
    ...
    -- get token for additional searchfield
    EXEC p_Token_01$get @c_languageId, N'TOK_POSITION', @l_tokSearchField   OUTPUT, @l_typeClass OUTPUT
    EXEC p_Token_01$get @c_languageId, N'TOK_PERSONFIRM', @l_tokSearchFieldII OUTPUT, @l_typeClass OUTPUT
...
-- term
    ...
    -- get token for additional searchfield
    EXEC p_Token_01$get @c_languageId, N'TOK_TERM_START_DATERANGE', @l_tokSearchField   OUTPUT, @l_typeClass OUTPUT
    EXEC p_Token_01$get @c_languageId, N'TOK_TERM_END_DATERANGE',   @l_tokSearchFieldII OUTPUT, @l_typeClass OUTPUT
...
-- product
    ...
    -- get token for additional searchfield
    EXEC p_Token_01$get @c_languageId, N'TOK_PRODUCTNO', @l_tokSearchField   OUTPUT, @l_typeClass OUTPUT
    EXEC p_Token_01$get @c_languageId, N'TOK_EAN',   @l_tokSearchFieldII OUTPUT, @l_typeClass OUTPUT
