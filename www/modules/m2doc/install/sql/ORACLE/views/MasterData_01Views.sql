 ...
 *
 * @version     $Id: MasterData_01Views.sql,v 1.5 2003/10/31 16:27:56 klaus Exp $
 *
 ...
 */
CREATE OR REPLACE VIEW v_MasterDataContainer_01$cont
AS
    SELECT  o.*,
            DECODE (f.owner, NULL,  '', f.owner) AS compowner,
