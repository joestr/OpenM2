...
--
-- @version     $Id: createBaseDomain.sql,v 1.9 2004/01/16 00:44:04 klaus Exp $
--
...
CALL IBSDEV1.p_dropProc ('pim2_createBaseDomain');
-- create new procedure:
CREATE PROCEDURE IBSDEV1.pim2_createBaseDomain ()
...
BEGIN
    ...
    DECLARE c_TVDiscussionContainer INT DEFAULT 16845057; -- 0x01010901
    DECLARE c_TVDiscussion  INT DEFAULT 16843521; -- 0x01010301
    DECLARE c_TVStore       INT DEFAULT 16845569; -- 0x01010B01
    DECLARE c_TVCatalog     INT DEFAULT 16845825; -- 0x01010C01
    DECLARE c_TVProductSourceContainer INT DEFAULT 16867585; -- 0x01016101
    DECLARE c_TVTerminplanContainer INT DEFAULT 16844289; -- 0x01010601
    DECLARE c_TVTerminplan  INT DEFAULT 16844545; -- 0x01010701
    DECLARE c_TVMasterDataContainer INT DEFAULT 16853249; -- 0x01012901
    DECLARE c_TVPhoneBookContainer INT DEFAULT 16858625; -- 0x01013e01
    DECLARE c_TVPBPersNumContainer INT DEFAULT 16861185; -- 0x01014801
...
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;
    ...
    -- Discussionen:
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDiscussions', l_name, l_desc);

    CALL IBSDEV1.p_DiscContainer_01$create
        (l_userId, 0, c_TVDiscussionContainer,
        l_name, l_public_s, 1, 0, c_NOOID_s, l_desc, l_cid_s);
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;

    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDiscM2', l_name, l_desc);

    CALL IBSDEV1.p_Discussion_01$create (l_userId, 0, c_TVDiscussion,
        l_name, l_cid_s, 1, 0, c_NOOID_s, l_desc, l_oid_s);
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;

    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDiscProjects', l_name, l_desc);
...
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;
    ...
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDiscInfoTips', l_name, l_desc);
...
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;
    ...
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDiscOffers', l_name, l_desc);
...
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;
    ...
    -- Warenangebote:
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domProducts', l_name, l_desc);

    CALL IBSDEV1.p_Object$create (l_userId, 0, c_TVStore, l_name,
        l_public_s, 1, 0, c_NOOID_s, l_desc, l_cid_s);
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;

/*
        EXEC p_ObjectDesc_01$get;c_languageId, 'OD_domProdLeaflets',;l_name OUTPUT,;l_desc OUTPUT
        EXEC;l_retValue = p_Catalog_01$create;l_userId, 1,;c_TVCatalog, -- Catalog
        ...
        EXEC;l_retValue = p_Object$create;l_userId, 0x00000001,;c_TVProductSourceContainer, -- ProductSourceContainer
            ;l_name,;l_cid_s, 1, 0,;c_NOOID_s,;l_desc,;l_oid_s OUTPUT
*/

    -- Termine:
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDates', l_name, l_desc);

    CALL IBSDEV1.p_Object$create (l_userId, 0, c_TVTerminplanContainer,
        l_name, l_public_s, 1, 0, c_NOOID_s, l_desc, l_cid_s);
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;

    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDatCommon', l_name, l_desc);

    CALL IBSDEV1.p_Object$create (l_userId, 0, c_TVTerminplan, l_name,
        l_cid_s, 1, 0, c_NOOID_s, l_desc, l_oid_s);
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;

    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDatAdvertising', l_name, l_desc);
...
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;
    ...
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDatEvents', l_name, l_desc);
...
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;
    ...
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domDatTraining', l_name, l_desc);
...
--    GET DIAGNOSTICS l_retValue = RETURN_STATUS;
    ...
    -- Stammdaten:
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domMasterData', l_name, l_desc);
    ...
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domMadSuppliers', l_name, l_desc);

    CALL IBSDEV1.p_Object$create (l_userId, 0, c_TVMasterDataContainer,
        l_name, l_cid_s, 1, 0, c_NOOID_s, l_desc, l_oid_s);
    GET DIAGNOSTICS l_retValue = RETURN_STATUS;

    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domMadMembers', l_name, l_desc);
    ...
    CALL IBSDEV1.p_ObjectDesc_01$get
        (c_languageId, 'OD_domMadPartners', l_name, l_desc);
...
CALL IBSDEV1.logError (300, 'cBDomain', l_sqlcode, 'finish', '', 0, 'l_msg', l_msg, '', 0, '', '', '', 0, '', '', '', 0, '', '', '', 0, '', '', '', 0, '', '', '', 0, '', '', '', 0, '', '', '', 0, '', '', '', 0, '', '');
    CALL IBSDEV1.p_debug (l_msg);
END;
-- pim2_createBaseDomain

-- execute procedure:
CALL IBSDEV1.pim2_createBaseDomain;
-- delete procedure:
CALL IBSDEV1.p_dropProc ('pim2_createBaseDomain');
