...
--
-- @version     $Id: ProductProfile_01Proc.sql,v 1.4 2003/10/31 00:12:51 klaus Exp $
--
...
CALL IBSDEV1.p_dropProc ('p_ProductProfile_01$create');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_ProductProfile_01$create
(
...
-- body:
    ...
    THEN 
        ...
        INSERT INTO IBSDEV1.m2_ProductProfile_01
            (oid, categories)
        VALUES  (l_oid, '');
...
--------------------------------------------------------------------------------
-- delete existing procedure:
CALL IBSDEV1.p_dropProc ('p_ProductProfile_01$change');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_ProductProfile_01$change
(
...
BEGIN 
    ...
    DECLARE l_begin         INT;
    DECLARE l_inc           INT;
    DECLARE l_oidstring     VARCHAR (20);
    DECLARE l_catoid        CHAR (8) FOR BIT DATA;
    DECLARE l_sqlcode       INT DEFAULT 0;
...
--------------------------------------------------------------------------------
-- delete existing procedure:
CALL IBSDEV1.p_dropProc ('p_ProductProfile_01$retrieve');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_ProductProfile_01$retrieve(
    -- common input parameters:
    IN    ai_oid_s          VARCHAR (18),
    IN    ai_userId         INT,
    IN    ai_op             INT,
...
--------------------------------------------------------------------------------
-- delete existing procedure:
CALL IBSDEV1.p_dropProc ('p_ProductProfile_01$delete');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_ProductProfile_01$delete(
    IN    ai_oid_s          VARCHAR (18),
    IN    ai_userId         INT,
    IN    ai_op             INT
    )
...
-- body:
    ...
    IF l_retValue = c_ALL_RIGHT THEN 
        ...
        DELETE FROM IBSDEV1.m2_ProductProfile_01
        WHERE oid = l_oid;
        GET DIAGNOSTICS l_rowcount = ROW_COUNT;
...
--------------------------------------------------------------------------------
-- delete existing procedure:
CALL IBSDEV1.p_dropProc ('p_ProductProfile_01$BOCopy');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_ProductProfile_01$BOCopy(
...
BEGIN 
    ...
    INSERT  INTO m2_ProductProfile_01
        (oid, categories )
    SELECT  ai_newOid, categories
    FROM IBSDEV1.   m2_ProductProfile_01
    WHERE   oid = ai_oid;
