    ...
    * @param errortext     an error text to display
    ...
    <xsl:template name="view">
        ...
        <xsl:choose>
            ...
            <!-- Multiselectable SELECTIONBOX -->
            <xsl:when test="$datatype = 'SELECTIONBOX' and $multiSelection=$BOOL_YES">
            ...
            </xsl:when> <!-- Multiselectable SELECTIONBOX -->

            <!-- Multiselectable QUERYSELECTIONBOX -->
            <xsl:when test="$datatype = 'QUERYSELECTIONBOX' and $multiSelection=$BOOL_YES">               
                <xsl:call-template name="formatMultiselValue">
                    <xsl:with-param name="value" select="$value"/>
                </xsl:call-template>
            </xsl:when> <!-- Multiselectable QUERYSELECTIONBOX -->
    ...
    <!-- **************************************************************************
    * Formats the value of a multiselection field for VIEW mode.
    *
    * @param value         the field value
    -->
    <xsl:template name="formatMultiselValue">
        <xsl:param name="value"/>
...
-->
    ...
    * @param tagName        	the field tag
    * @param classId        	css class
    * @param searchFieldClassId	css class of search field
    * @param style         		css style
    * @param size           	size
    * @param maxlength      	maxlength
    * @param mandatory      	mandatory option (true|false)
    ...
    * @param showSearchParams 	defines if the extended search params should be display initially
    ...
    <xsl:param name="tagName"/>
    <xsl:param name="classId"/>
    <xsl:param name="searchFieldClassId"/>
    <xsl:param name="style"/>
		...
		<TR>
			<TD COLSPAN="4">
		        ...
		        <xsl:call-template name="internDt_input">
		            ...
		            <xsl:with-param name="classId" select="$searchFieldClassId"/>
		            <xsl:with-param name="style" select="$style"/>
		            <xsl:with-param name="size" select="$size"/>
		            <xsl:with-param name="maxlength" select="$maxlength"/>
		            <xsl:with-param name="mandatory" select="translate ($mandatory, 'TRUEYSJA', 'trueysja')=$BOOL_YES"/>
        ...
        <TABLE CLASS="fieldRef" BORDERCOLOR="#FFFFFF" BORDER="0"
            ...
            <TBODY>
                <xsl:call-template name="createFieldrefStructure">
                    ...
                    <xsl:with-param name="searchFieldClassId" select="$searchFieldClassId"/>
                    <xsl:with-param name="size" select="$size"/>
                    <xsl:with-param name="maxlength" select="$maxlength"/>
                    <xsl:with-param name="mandatory" select="$mandatory"/>
                    <xsl:with-param name="readonly" select="$readonly"/>
