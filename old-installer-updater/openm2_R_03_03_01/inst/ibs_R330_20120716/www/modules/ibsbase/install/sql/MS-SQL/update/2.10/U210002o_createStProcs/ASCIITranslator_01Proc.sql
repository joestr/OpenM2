...
EXEC p_dropProc N'p_ASCIITranslator_01$create'
GO

-- create the new procedure:
CREATE PROCEDURE p_ASCIITranslator_01$create
(
...
AS
    ...
    DECLARE @l_rights               RIGHTS
    DECLARE @l_actRights            RIGHTS
...
*/
        -- create base object:
        EXEC @l_retValue = p_Translator_01$create @ai_userId, @ai_op, @ai_tVersionId,
        ...
        BEGIN
            ...
            INSERT INTO ibs_ASCIITranslator_01 (oid, separator, escapeSeparator,
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_ASCIITranslator_01$change'
GO

-- create the new procedure:
CREATE PROCEDURE p_ASCIITranslator_01$change
(
    -- common input parameters:
    ...
    @ai_separator           NVARCHAR(15),
    @ai_escapeSeparator     NVARCHAR(15),
    @ai_isIncludeMetadata   BOOL,
    @ai_isIncludeHeader     BOOL
)
AS
    -- definitions:
    -- define return constants:
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_ASCIITranslator_01$retrieve'
GO

-- create the new procedure:
CREATE PROCEDURE p_ASCIITranslator_01$retrieve
(
    -- input parameters:
    @ai_oid_s               OBJECTIDSTRING,
    @ai_userId              USERID,
    ...
    @ao_separator           NVARCHAR(15)    OUTPUT,
    @ao_escapeSeparator     NVARCHAR(15)    OUTPUT,
    @ao_isIncludeMetadata   BOOL            OUTPUT,
    @ao_isIncludeHeader     BOOL            OUTPUT
)
AS
    -- definitions:
    -- define return constants:
...
*/
        ...
        BEGIN
            ...
            SELECT  @ao_separator           = separator,
                    @ao_escapeSeparator     = escapeSeparator,
                    @ao_isIncludeMetadata   = isIncludeMetadata,
                    @ao_isIncludeHeader     = isIncludeHeader
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_ASCIITranslator_01$BOCopy'
GO

-- create the new procedure:
CREATE PROCEDURE p_ASCIITranslator_01$BOCopy
(
    -- common input parameters:
    @ai_oid             OBJECTID,
    @ai_userId          USERID,
...
*/
        ...
        BEGIN
            ...
            EXEC @l_error = ibs_error.prepareErrorCount @@error, @@ROWCOUNT,
                N'insert new ascii translator data', @l_ePos OUTPUT, @l_count OUTPUT
...
*/
    -- log the error:
    EXEC ibs_error.logError 500, N'p_ASCIITranslator_01$BOCopy', @l_error,
            @l_ePos,
