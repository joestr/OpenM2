 ...
 *
 * @version     $Id: U300009p_WorkspaceProc.sql,v 1.1 2010/05/21 10:05:35 btatzmann Exp $
 *
...
EXEC p_dropProc N'p_Workspace_01$create'
GO
...
-- body:
    ...
    BEGIN
        BEGIN TRANSACTION
            ...
            EXEC p_ObjectDesc_01$get @c_languageId, N'OD_wspPrivate', @l_name OUTPUT, @l_desc OUTPUT
            ...
            SELECT  @execStr = N'EXEC ' + @workspaceProc + N' ' +
                    CONVERT (VARCHAR (12), @userId) + N', ' +
                    CONVERT (VARCHAR (12), @op) + N', ' +
                    CONVERT (VARCHAR (12), @wUserId) + N', ' +
                    CONVERT (VARCHAR (12), @domainId) + N', ' +
                    N'''' + @workspace_s + N''''
            EXEC (@execStr)
            ...
            BEGIN                       -- workspace was created
                ...
                WHERE   name IN (N'new', N'view', N'read', N'change', N'delete',
                            N'viewRights', N'setRights', N'createLink',
                            N'distribute', N'addElem', N'delElem', N'viewElems',
                            N'viewProtocol')
                IF (@workBox <> @c_NOOID)
                BEGIN
                ...
                BEGIN
                    SELECT  @l_rights = sum (id)
                    FROM    ibs_Operation
                    WHERE   name IN (N'view', N'read', N'change',
                                N'viewRights', N'setRights', N'createLink',
                                N'viewElems', N'viewProtocol')
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Workspace_01$createObjects'
GO
...
*/
    -- hotList
    EXEC p_ObjectDesc_01$get @c_languageId, N'OD_wspHotList', @l_name OUTPUT, @l_desc OUTPUT
...
*/
    -- profile
    EXEC p_ObjectDesc_01$get @c_languageId, N'OD_wspProfile', @l_name OUTPUT, @l_desc OUTPUT
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Workspace_01$change'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Workspace_01$retrieve'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Workspace_01$retrieveForActU'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Workspace_01$delete'
GO
