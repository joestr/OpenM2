 ...
 *
 * @version     $Id: U300005p_ObjectProc1.sql,v 1.1 2010/04/20 21:10:06 rburgermann Exp $
 *
...
EXEC p_dropProc N'p_Object$create'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$getTabOid'
GO
...
-- body:
    ...
    EXEC @l_error = ibs_error.prepareErrorCount @@error, @@ROWCOUNT,
        N'get tab oid', @l_ePos OUTPUT, @l_rowCount OUTPUT
...
exception:                              -- an error occurred
    -- log the error:
    EXEC ibs_error.logError 500, N'p_Object$getTabOid', @l_error, @l_ePos,
            N'', 0,
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$createTab'
GO
...
-- body:
    ...
    BEGIN
       ...
       SELECT @l_tabTVersionId = t.tVersionId,
                ...
                @l_tabProc = COALESCE (p.name, N'p_Object$create'),
                @l_consistsOfId = c.id,
                @l_state = o.state
        ...
        -- check if there occurred an error:
        EXEC @l_error = ibs_error.prepareErrorCount @@error, @@ROWCOUNT,
            N'get tab data', @l_ePos OUTPUT, @l_rowCount OUTPUT
        ...
        BEGIN
            ...
            -- check if there occurred an error:
            EXEC @l_error = ibs_error.prepareErrorCount @@error, @@ROWCOUNT,
                N'update consistsOfId', @l_ePos OUTPUT, @l_rowCount OUTPUT
            IF (@l_error <> 0 OR @l_rowCount <= 0) -- an error occurred?
                GOTO exception          -- call common exception handler
...
exception:                              -- an error occurred
    -- log the error:
    EXEC ibs_error.logError 500, N'p_Object$createTab', @l_error, @l_ePos,
            N'ai_userId', @ai_userId,
            N'l_oid_s', @l_oid_s,
            N'ai_op', @ai_op,
            N'ai_tabCode', @ai_tabCode,
            N'', 0,
            N'l_tabOid_s', @l_tabOid_s
    -- return error code:
    RETURN  @c_NOT_OK
GO
-- p_Object$createTab
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$createTabs'
GO
...
exception:                              -- an error occurred
    -- log the error:
    EXEC ibs_error.logError 500, N'p_Object$createTabs', @l_error, @l_ePos,
            N'ai_userId', @ai_userId,
            N'', N'',
            N'ai_op', @ai_op,
            N'', N'',
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$deleteTab'
GO
...
-- body:
    -- get the tab data:
    SELECt @l_tabProc = COALESCE (p.name, N'p_Object$delete'),
            @l_tabOid = o.oid
    FROM ibs_Object o
           LEFT OUTER JOIN
           ibs_TVersionProc p
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$performCreate'
GO
...
-- declarations
    ...
    SELECT
        @l_id = 0,
        @l_origId = 0,
        @l_typeCode = N'UNKNOWN',
        @l_typeName = N'UNKNOWN',
        @l_showInMenu = 0,
        @l_showInNews = 0,
...
--EXEC p_showActDateTime 'after posnopath'
            ...
            --
            -- 3. get type-info: type name, type code, icon and containerId, 
            --                   showInMenus, showInNews
            --
            SELECT  @l_typeName = t.name, @l_typeCode = t.code, 
                    @l_isContainer = t.isContainer, @l_showInMenu = t.showInMenu, 
                    @l_showInNews = t.showInNews * 4, @l_icon = t.icon
...
--EXEC p_showActDateTime 'after type  '
            ...
            BEGIN
                ...
                SELECT  @l_name = name, @l_typeName = typeName, @l_typeCode = typeCode,
            ...
            ELSE
            BEGIN
                IF (@l_name = N'' OR @l_name = N' ' OR @l_name IS NULL)
...
--EXEC p_showActDateTime 'before insert'
            ...
            VALUES (@l_id, @ao_oid, /*???,*/ @ai_tVersionId, @l_typeName,
                    @l_typeCode, @l_isContainer, @l_name,
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$performCreateWithId'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$store'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$performChange'
GO
...
-- body:
    ...
    -- check if there occurred an error:
    EXEC @l_error = ibs_error.prepareErrorCount @@error, @@ROWCOUNT,
        N'get the data of the object', @l_ePos OUTPUT, @l_count OUTPUT
    IF (@l_error <> 0)                  -- an error occurred?
        GOTO exception                  -- call common exception handler
...
*/
        ...
        BEGIN
            ...
            BEGIN
                ...
                -- check if there occurred an error:
                EXEC @l_error = ibs_error.prepareErrorCount @@error, @@ROWCOUNT,
                    N'get the state of the container',
            ...
            EXEC @l_error = ibs_error.prepareError @@error,
                N'store the values', @l_ePos OUTPUT
            IF (@l_error <> 0)      -- an error occurred?
            ...
            -- check if there occurred an error:
            EXEC @l_error = ibs_error.prepareError @@error,
                N'set states of tab objects', @l_ePos OUTPUT
            IF (@l_error <> 0)          -- an error occurred?
                GOTO exception          -- call exception handler
            ...
            -- check if there occurred an error:
            EXEC @l_error = ibs_error.prepareErrorCount @@error, @@ROWCOUNT,
                N'get the full name of the user', @l_ePos OUTPUT, @l_count OUTPUT
            IF (@l_error <> 0 OR @l_count = 0) -- an error occurred?
                GOTO exception          -- call exception handler
            ...
            -- check if there occurred an error:
            EXEC @l_error = ibs_error.prepareError @@error,
                N'create protocol entry', @l_ePos OUTPUT
            IF (@l_error <> 0)          -- an error occurred?
                GOTO exception          -- call exception handler
        END -- if the user has the rights
        ELSE                            -- the user does not have the rights
...
exception:                              -- an error occurred
    ...
    -- log the error:
    EXEC ibs_error.logError 500, N'p_Object$performChange', @l_error, @l_ePos,
        N'ai_userId', @ai_userId,
        N'ai_oid_s', @ai_oid_s,
        N'ai_op', @ai_op,
        N'ai_name', @ai_name,
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$change'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$move'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$performMove'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$changeState'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$changeProcessState'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$changeOwnerRec'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$changeTabsOwner'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$insertProtocol'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$performRetrieve2'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$performRetrieve'
GO
...
-- body:
    ...
    -- check if there occurred an error:
    EXEC @l_error = ibs_error.prepareErrorCount @@error, @@ROWCOUNT,
        N'get containerId', @l_ePos OUTPUT, @l_rowCount OUTPUT
    IF (@l_error <> 0)                  -- an error occurred?
        GOTO exception                  -- call common exception handler
    ...
    BEGIN
        ...
        BEGIN
            ...
            -- check if there occurred an error:
            EXEC @l_error = ibs_error.prepareError @@error,
                N'get the data of the object', @l_ePos OUTPUT
            IF (@l_error <> 0)          -- an error occurred?
                GOTO exception          -- call common exception handler
            ...
            BEGIN
                ...
                -- check if there occurred an error:
                EXEC @l_error = ibs_error.prepareError @@error,
                    N'get the check out info', @l_ePos OUTPUT
                IF (@l_error <> 0)      -- an error occurred?
                    GOTO exception      -- call common exception handler
...
exception:                              -- an error occurred
    -- log the error:
    EXEC ibs_error.logError 500, N'p_Object$performRetrieve', @l_error, @l_ePos,
            N'ai_userId', @ai_userId,
            N'ai_oid_s', @ai_oid_s,
            N'ai_op', @ai_op
    -- return error code:
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$retrieve2'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$retrieve'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$getUpperOid'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$getTabInfo'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$performDelete'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$performDeleteCustomized'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$delete'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$performUnDelete'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$undelete'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$deleteAllRefs'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$getMasterOid'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$test'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$checkOut'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$checkIn'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_Object$resolveObjectPath'
GO
...
-- body:
    ...
    ELSE
    BEGIN                               -- special case
        IF (@ai_userName = N'')          -- not in a private area
        BEGIN
