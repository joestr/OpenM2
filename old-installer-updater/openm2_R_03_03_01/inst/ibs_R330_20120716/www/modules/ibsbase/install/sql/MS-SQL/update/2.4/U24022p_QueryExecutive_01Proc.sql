 ...
 * Search - Queries. <BR>
 *
 * @version     $Id: U24022p_QueryExecutive_01Proc.sql,v 1.1 2006/01/27 17:18:10 klreimue Exp $
 *
...
p_dropProc 'p_QueryExecutive_01$create'
GO
 ...
 */
-- delete existing procedure:
p_dropProc 'p_QueryExecutive_01$change'
GO
-- create the new procedure:
 ...
 */
-- delete existing procedure:
p_dropProc 'p_QueryExecutive_01$retrieve'
GO
-- create the new procedure:
 ...
 */
-- delete existing procedure:
p_dropProc 'p_QueryExecutive_01$BOCopy'
GO
-- create the new procedure:
