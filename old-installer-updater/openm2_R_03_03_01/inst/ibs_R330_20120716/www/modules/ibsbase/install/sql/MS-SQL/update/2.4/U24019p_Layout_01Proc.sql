...
EXEC p_dropProc 'p_Layout_01$create'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Layout_01$change'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Layout_01$retrieve'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_Layout_01$delete'
GO
...
-- delete existing procedure:
EXEC p_dropProc 'p_Layout_01$BOCopy'
GO
