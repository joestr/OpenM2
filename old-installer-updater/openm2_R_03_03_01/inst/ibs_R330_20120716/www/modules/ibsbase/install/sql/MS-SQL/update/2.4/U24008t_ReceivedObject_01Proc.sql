 ...
 * 
 * @version     $Id: U24008t_ReceivedObject_01Proc.sql,v 1.1 2005/03/04 22:07:24 klaus Exp $
 *
...
EXEC p_dropProc 'p_ReceivedObject_01$create'
GO
...
*/
        ...
        BEGIN
	        ...
	        VALUES (@oid, 0,
	                0, null, 'not defined',
	                'icon.gif', 'no defined', 0, @l_senderFullName)
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_ReceivedObject_01$change'
GO
...
*/
    ...
    BEGIN
        ...
        IF (@distributedName = '' OR @distributedName IS NULL OR
            @distributedIcon = '' OR @distributedIcon IS NULL)
        BEGIN
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_ReceivedObject_01$retrieve'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_ReceivedObject_01$delete'
GO
