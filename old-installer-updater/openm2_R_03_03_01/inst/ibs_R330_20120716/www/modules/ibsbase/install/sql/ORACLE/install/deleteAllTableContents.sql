 ...
 *
 * @version     $Id: deleteAllTableContents.sql,v 1.3 2003/10/21 08:53:13 klaus Exp $
 *
...
--    debug ('');
    ...
    debug ('TRUNCATE wurde für alle ibs Tabellen durchgeführt.');
EXCEPTION
    WHEN OTHERS THEN
        err;
END;
