 ...
 *
 * @version     $Id: U24002r_AttachmentContainer_01Proc.sql,v 1.1 2005/01/27 01:20:30 klaus Exp $
 *
...
EXEC p_dropProc 'p_AC_01$create'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_AC_01$change'
GO
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_AC_01$retrieve'
GO
    ...
    BEGIN TRANSACTION
        ...
        BEGIN      	
            ...
            ELSE  -- Container is empty and therefore no master attachment defined
                BEGIN
                    SELECT @fileName = 'kein Masterfile definiert'
                    SELECT @url = 'keine MasterUrl definiert'
                END        
 ...
 */
-- delete existing procedure:
EXEC p_dropProc 'p_AC_01$delete'
GO
...
-- AJ 990425 changed ... //////////////////////////////////////////////////////
-- delete existing procedure:
EXEC p_dropProc 'p_AC_01$BOCopy'
GO
