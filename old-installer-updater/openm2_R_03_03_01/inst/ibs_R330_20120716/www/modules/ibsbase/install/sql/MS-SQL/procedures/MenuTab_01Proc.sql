 ...
 *
 * @version     $Id: MenuTab_01Proc.sql,v 1.7 2009/12/02 18:35:02 rburgermann Exp $
 *
...
-- delete existing procedure:
EXEC p_dropProc N'p_MenuTab_01$create'
GO
...
DECLARE
    ...
    BEGIN
        ...
        VALUES (@l_oid, @c_NOOID, N' ',
            0,0,0, N'groupFront.gif', N'groupBack.gif', N'welcome.htm', 0, 0)
...
-- delete existing procedure:
EXEC p_dropProc N'p_MenuTab_01$change'
GO
...
-- body
    ...
    BEGIN
        ...
        SET @ai_front = @ai_front + N'.'
        SET @ai_back = @ai_back + N'.'
        ...
        SET     objectoid = @l_objectoid,
                ...
                classfront = substring (@ai_front, 1, charindex (N'.', @ai_front)-1),
                classback = substring (@ai_back, 1, charindex (N'.', @ai_back)-1),
...
-- delete existing procedure:
EXEC p_dropProc N'p_MenuTab_01$retrieve'
GO
...
-- delete existing procedure:
EXEC p_dropProc N'p_MenuTab_01$delete'
GO
