...
--
-- @version     $Id: deleteAllTableContents.sql,v 1.6 2003/10/21 22:37:48 klaus Exp $
--
...
CALL IBSDEV1.p_dropProc ('pi_deleteAllTableContents');
-- create new procedure:
CREATE PROCEDURE IBSDEV1.pi_deleteAllTableContents ()
...
-- body:
    ...
    return l_count;
END;
-- pi_deleteAllTableContents

-- execute procedure:
CALL IBSDEV1.pi_deleteAllTableContents;
-- delete procedure:
CALL IBSDEV1.p_dropProc ('pi_deleteAllTableContents');
