 ...
 *
 * @version     $Id: U300002p_UserProfileProc.sql,v 1.3 2010/05/04 09:24:20 btatzmann Exp $
 *
...
EXEC p_dropProc N'p_UserProfile_01$create'
GO
    ...
    BEGIN
        ...
        INSERT INTO ibs_UserProfile
                (oid, userId, newsTimeLimit, newsShowOnlyUnread, outboxUseTimeLimit,
                 ...
                 notificationKind, sendSms, addWeblink, localeId
                 )
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_UserProfile_01$change'
GO
...
AS
    ...
    EXEC p_stringToByte @localeId_s, @localeId OUTPUT
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_UserProfile_01$retrieve'
GO
...
(
    ...
    @m2AbsBasePath          NVARCHAR (255)  OUTPUT,
    @home                   NVARCHAR (255)  OUTPUT,
    ...
    @LocaleId               OBJECTID        OUTPUT,
    @LocaleName             NAME            OUTPUT
)
AS
    -- DEFINITIONS
    -- define return constants
 ...
 */
-- delete existing procedure:
EXEC p_dropProc N'p_UserProfile_01$delete'
GO
