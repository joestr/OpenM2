-------------------------------------------------------------------------------
-- Drop all tables within the framework. <BR>
--
-- @version     $Id: dropAllTables.sql,v 1.6 2003/10/21 22:37:48 klaus Exp $
--
...
DROP PROCEDURE IBSDEV1.pi_dropAllTables;
-- create new procedure
CREATE PROCEDURE IBSDEV1.pi_dropAllTables ()
...
-- body:
    ...
    DO
        ...
        SET l_exec = 'DROP TABLE IBSDEV1.' || l_name;
