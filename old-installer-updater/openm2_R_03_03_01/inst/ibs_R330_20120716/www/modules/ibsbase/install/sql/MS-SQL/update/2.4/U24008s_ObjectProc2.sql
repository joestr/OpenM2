 ...
 *
 * @version     $Id: U24008s_ObjectProc2.sql,v 1.1 2005/03/04 22:05:30 klaus Exp $
 *
...
EXEC p_dropProc 'p_Object$switchCopy'
GO
...
-- ... AJ 990525 inserted /////////////////////////////////////////////////////
    ...
    END -- ASCIITranslator
    ELSE IF (@l_typeCode = 'EDITranslator') -- EDITranslator
    BEGIN
...
-- body:
    ...
    BEGIN
        ...
        BEGIN TRANSACTION
            ...
            SELECT  @l_copyId = COALESCE (MAX (copyId) + 1, 1)
            FROM    ibs_Copy
                ...
                BEGIN
                    ...
                    INSERT INTO ibs_Object
                           (id, oid, state, tVersionId,
                            typeName, isContainer, name,
                            containerId, containerKind,
                            containerOid2,
                    ...
                    VALUES (@l_newId, @l_newOid, @l_newState, @l_newTVersionId,
                            @l_newTypeName, @l_newIsContainer, @l_newName,
                            @l_newContainerId, @l_newContainerKind,
                            @l_newContainerOid2,
