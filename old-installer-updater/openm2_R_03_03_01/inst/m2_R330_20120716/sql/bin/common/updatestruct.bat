...
rem echo   installing tables...
rem %dbexec% %pkgSourceDir%tables   >> "%pkgLogName%05_tables_%fileName%.log"

rem echo   creating indexes...
rem %db% %pkgSourceDir%always\createIndices.sql >> "%pkgLogName%06_indices_%fileName%.log"
