 ...
 *
 * @version     $Id: DocumentTemplate_01Views.sql,v 1.5 2003/10/31 00:13:08 klaus Exp $
 *
...
AS
    ...
    UNION
    -- select all document templates referenced by a xml discussion object
    SELECT DISTINCT t.oid
    FROM ibs_DocumentTemplate_01 t, m2_XMLDiscussionTemplate_01 x, ibs_Object o
    WHERE (t.oid = x.level1 OR t.oid = x.level2 OR t.oid = x.level3)
    AND x.oid = o.oid AND o.state = 2
    UNION
