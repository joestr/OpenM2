...
--
-- @version     $Id: Discussion_01Proc.sql,v 1.4 2003/10/31 00:12:50 klaus Exp $
--
...
CALL IBSDEV1.p_dropProc ('p_Discussion_01$create');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_Discussion_01$create
(
    -- input parameters:
    IN  ai_userId           INT,
    IN  ai_op               INT,
...
--------------------------------------------------------------------------------
-- delete existing procedure:
CALL IBSDEV1.p_dropProc ('p_Discussion_01$change');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_Discussion_01$change(
...
-- body:
    ...
    IF l_retValue = c_ALL_RIGHT THEN 
        ...
        SET maxlevels = ai_maxlevels,
            defaultView = ai_defaultView
        WHERE oid = l_oid;
    END IF;
...
--------------------------------------------------------------------------------
-- delete existing procedure:
CALL IBSDEV1.p_dropProc ('p_Discussion_01$retrieve');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_Discussion_01$retrieve(
    -- input parameters:
    IN  ai_oid_s            VARCHAR (18),
    IN  ai_userId           INT,
    IN  ai_op               INT,
...
-- body:
    ...
    IF l_retValue = c_ALL_RIGHT THEN 
        ...
        INTO ao_maxlevels, ao_defaultView
...
--------------------------------------------------------------------------------
-- delete existing procedure:
CALL IBSDEV1.p_dropProc ('p_Discussion_01$delete');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_Discussion_01$delete(
    IN  ai_oid_s            VARCHAR (18),
    IN  ai_userId           INT,
    IN  ai_op               INT
    )
...
------------------------------------------------------------------------
-- delete existing procedure:
CALL IBSDEV1.p_dropProc ('p_Discussion_01$BOCopy');

-- create the new procedure:
CREATE PROCEDURE IBSDEV1.p_Discussion_01$BOCopy(
...
-- body:  
    ...
    INSERT INTO IBSDEV1.m2_Discussion_01 
        (oid, maxlevels, defaultView, refOid)
    SELECT  ai_newOid, b.maxlevels, b.defaultView, b.refOid
    FROM IBSDEV1.   m2_Discussion_01 b
    WHERE   b.oid = ai_oid;
