    ...
    <xsl:template match="/OBJECT">
        ...
        <SCRIPT LANGUAGE="JavaScript">
            function xslSubmitAllowed()
            {
                ...
                name = document.sheetForm.<xsl:value-of select="VALUES/VALUE[@FIELD='Staff member']/@INPUT"/>_0.value;

                document.sheetForm.<xsl:value-of select="SYSTEM/NAME/@INPUT"/>.value = name;
