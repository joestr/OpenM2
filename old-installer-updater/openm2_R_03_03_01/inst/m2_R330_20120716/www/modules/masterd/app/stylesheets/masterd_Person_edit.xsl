    ...
    <xsl:template match="/OBJECT">
        ...
        <SCRIPT LANGUAGE="JavaScript">
            function xslSubmitAllowed()
            {
                ...
                firstname = document.sheetForm.<xsl:value-of select="VALUES/VALUE[@FIELD='First name']/@INPUT"/>.value;
                surname = document.sheetForm.<xsl:value-of select="VALUES/VALUE[@FIELD='Surname']/@INPUT"/>.value;
                //title = document.sheetForm.<xsl:value-of select="VALUES/VALUE[@FIELD='Title']/@INPUT"/>_0.value;
                salutation = document.sheetForm.<xsl:value-of select="VALUES/VALUE[@FIELD='Salutation']/@INPUT"/>.value;
                
                //if (title == ' ')
                //{
                    document.sheetForm.<xsl:value-of select="SYSTEM/NAME/@INPUT"/>.value = salutation+' '+surname+' '+firstname;
                //}
                //else
                //{
                //    document.sheetForm.<xsl:value-of select="SYSTEM/NAME/@INPUT"/>.value = salutation+' '+surname+' '+firstname+', '+title;
                //}
