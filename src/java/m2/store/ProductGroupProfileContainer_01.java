/*
 * Class: ProductGroupProfileContainer_01.java
 */
 ...
 * <BR/>
 *
 * @version     $Id: ProductGroupProfileContainer_01.java,v 1.9 2009/07/25 00:43:12 kreimueller Exp $
 *
 * @author      Bernhard Walter (BW), 981228
 ******************************************************************************
 */
public class ProductGroupProfileContainer_01 extends Container
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: ProductGroupProfileContainer_01.java,v 1.9 2009/07/25 00:43:12 kreimueller Exp $";

    /**
     * Icon for the object. <BR/>
     */
    private static final String CLASS_ICON = "ProductGroupProfileContainer.gif";


    /**************************************************************************
     * This constructor creates a new instance of the class
     * ProductGroupProfileContainer_01. <BR/>
     */
    public ProductGroupProfileContainer_01 ()
    {
    ...
    } // ProductGroupProfileContainer_01
     ...
     */
    public ProductGroupProfileContainer_01 (OID oid, User user)
    {
        // call constructor of super class ObjectReference:
        super (oid, user);
        // initialize properties common to all subclasses:
    ...
    public void initClassSpecifics ()
    {
        ...
        this.icon = ProductGroupProfileContainer_01.CLASS_ICON;
    } // initClassSpecifics
...
} // class ProductGroupProfileContainer_01
