 ...
 * </UL>
 *
 * @version     $Id: MadFunctions.java,v 1.11 2007/07/31 19:14:02 kreimueller Exp $
 *
 * @author      Klaus Reimüller (KR), 98049
 ******************************************************************************
 */
public abstract class MadFunctions extends Object
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: MadFunctions.java,v 1.11 2007/07/31 19:14:02 kreimueller Exp $";



    /**
     * The user must fill in the form to register himself. <BR/>
     */
    public static final int FCT_SHOWFORM = 10001;

    /**
     * The objects are created and the frameset shall be shown afterwards. <BR/>
     */
    public static final int FCT_CREATEOBJECTS = 10002;
