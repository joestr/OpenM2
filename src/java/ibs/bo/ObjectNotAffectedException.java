/*
 * Class: ObjectNotAffectedException.java
 */
 ...
 *
 * @version     $Id: ObjectNotAffectedException.java,v 1.8 2007/07/27 12:01:42 kreimueller Exp $
 *
 * @author      Klaus Reimüller (KR) 980622
 ******************************************************************************
 */
public class ObjectNotAffectedException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: ObjectNotAffectedException.java,v 1.8 2007/07/27 12:01:42 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 6747932055369279593L;


    /**************************************************************************
     * Create a new ObjectNotAffectedException. <BR/>
     *
     * @param   name    The name of the error object representing the class that
     *                  raised an error first.
     */
    public ObjectNotAffectedException (String name)
    {
        super (name);                   // call constructor of usper class
    } // ObjectNotAffectedException
