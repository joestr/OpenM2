/*
 * Class: TypeNotFoundException.java
 */
 ...
 *
 * @version     $Id: TypeNotFoundException.java,v 1.6 2007/07/27 12:01:42 kreimueller Exp $
 *
 * @author      Klaus Reimüller (KR) 001023
 ******************************************************************************
 */
public class TypeNotFoundException extends GeneralException
{
    /**
    ...
    public static final
    String VERSIONINFO =
        "$Id: TypeNotFoundException.java,v 1.6 2007/07/27 12:01:42 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 5682824074213754846L;
