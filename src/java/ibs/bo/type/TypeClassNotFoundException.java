/*
 * Class: TypeClassNotFoundException.java
 */
 ...
 *
 * @version     $Id: TypeClassNotFoundException.java,v 1.4 2007/07/27 12:01:42 kreimueller Exp $
 *
 * @author      Klaus Reimüller (KR) 001023
 ******************************************************************************
 */
public class TypeClassNotFoundException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: TypeClassNotFoundException.java,v 1.4 2007/07/27 12:01:42 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 226956304075627642L;


    /**************************************************************************
     * Create a new TypeClassNotFoundException. <BR/>
     *
     * @param   name    The name of the error object representing the class that
     *                  raised an error first.
     */
    public TypeClassNotFoundException (String name)
    {
     ...
     *                  or unknown.)
     */
    public TypeClassNotFoundException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // TypeClassNotFoundException

} // class TypeClassNotFoundException
