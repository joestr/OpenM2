/*
 * Class: ObjectNotFoundException.java
 */
 ...
 *
 * @version     $Id: ObjectNotFoundException.java,v 1.8 2007/07/27 12:01:42 kreimueller Exp $
 *
...
public class ObjectNotFoundException extends GeneralException
{
    ...
    public static final String VERSIONINFO =
        "$Id: ObjectNotFoundException.java,v 1.8 2007/07/27 12:01:42 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 9085452027889396433L;


    /**************************************************************************
     * Create a new ObjectNotFoundException. <BR/>
     *
