/*
 * Class: ObjectClassNotFoundException.java
 */
 ...
 *
 * @version     $Id: ObjectClassNotFoundException.java,v 1.9 2007/07/27 12:01:42 kreimueller Exp $
 *
 * @author      Klaus Reimüller (KR) 001023
 ******************************************************************************
 */
public class ObjectClassNotFoundException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: ObjectClassNotFoundException.java,v 1.9 2007/07/27 12:01:42 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 7692887352359184190L;


    /**************************************************************************
     * Create a new ObjectClassNotFoundException. <BR/>
     *
     * @param   name    The name of the error object representing the class that
     *                  raised an error first.
     */
    public ObjectClassNotFoundException (String name)
    {
     ...
     *                  or unknown.)
     */
    public ObjectClassNotFoundException (String name, Throwable cause)
    {
