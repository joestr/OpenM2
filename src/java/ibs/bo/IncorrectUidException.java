/*
 * Class: IncorrectUidException.java
 */
 ...
 *
 * @version     $Id: IncorrectUidException.java,v 1.8 2007/07/27 12:01:42 kreimueller Exp $
 *
 * @author      Klaus Reimüller (KR) 980421
 ******************************************************************************
 */
public class IncorrectUidException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: IncorrectUidException.java,v 1.8 2007/07/27 12:01:42 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 7472385268770111080L;


    /**************************************************************************
     * Create a new IncorrectUidException. <BR/>
     *
     * @param   name    The name of the error object representing the class that
     *                  raised an error first.
     */
    public IncorrectUidException (String name)
    {
        super (name);                   // call constructor of upper class
    } // IncorrectUidException

} // class IncorrectUidException
