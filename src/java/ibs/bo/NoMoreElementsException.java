/*
 * Class: NoMoreElementsException.java
 */
 ...
 *
 * @version     $Id: NoMoreElementsException.java,v 1.8 2007/07/27 12:01:42 kreimueller Exp $
 *
 * @author      Klaus Reimüller (KR) 980403
 ******************************************************************************
 */
public class NoMoreElementsException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: NoMoreElementsException.java,v 1.8 2007/07/27 12:01:42 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 2125033037290824179L;


    /**************************************************************************
     * Create a new NoMoreElementsException. <BR/>
     *
     * @param   name    The name of the error object representing the class that
     *                  raised an error first.
     */
    public NoMoreElementsException (String name)
    {
