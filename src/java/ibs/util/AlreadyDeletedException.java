/*
 * Class: AlreadyDeletedException.java
 */
 ...
 *
 * @version     $Id: AlreadyDeletedException.java,v 1.8 2007/07/31 19:14:00 kreimueller Exp $
 *
 * @author      Mario Stegbauer (MS) 990630
 ******************************************************************************
 */
public class AlreadyDeletedException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: AlreadyDeletedException.java,v 1.8 2007/07/31 19:14:00 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 8253374674455654780L;
     ...
     */
    public AlreadyDeletedException (String name)
    {
     ...
     *                  or unknown.)
     */
    public AlreadyDeletedException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // AlreadyDeletedException
