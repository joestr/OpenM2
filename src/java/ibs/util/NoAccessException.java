 ...
 *
 * @version     $Id: NoAccessException.java,v 1.8 2007/07/31 19:14:00 kreimueller Exp $
 *
 * @author      Klaus Reimüller (KR) 980306
 ******************************************************************************
 */
public class NoAccessException extends GeneralException
{
    ...
    public static final String VERSIONINFO =
        "$Id: NoAccessException.java,v 1.8 2007/07/31 19:14:00 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 8773843837289284077L;
     ...
     */
    public NoAccessException (String name)
    {
     ...
     *                  or unknown.)
     */
    public NoAccessException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // NoAccessException
