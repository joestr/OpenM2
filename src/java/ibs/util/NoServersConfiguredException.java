/*
 * Class: NoServersConfiguredException
 */
 ...
 * configured for. <BR/>
 *
 * @version     $Id: NoServersConfiguredException.java,v 1.7 2007/07/31 19:14:00 kreimueller Exp $
 *
 * @author      Bernd Martin (BM), 001205
 ******************************************************************************
 */
public class NoServersConfiguredException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: NoServersConfiguredException.java,v 1.7 2007/07/31 19:14:00 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 6975674431859715644L;
     ...
     */
    public NoServersConfiguredException (String name)
    {
     ...
     *                  or unknown.)
     */
    public NoServersConfiguredException (Throwable cause)
    {
     ...
     *                  or unknown.)
     */
    public NoServersConfiguredException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // NoServersConfiguredException
