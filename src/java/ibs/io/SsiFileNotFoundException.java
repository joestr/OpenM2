/*
 * Class: SsiFileNotFoundException.java
 */
...
/******************************************************************************
 * Exception thrown if a SSI file cannot be found on the given address. <BR/>
 *
 * @version     $Id: SsiFileNotFoundException.java,v 1.5 2007/07/20 13:07:56 kreimueller Exp $
 *
 * @author      Bernd Marin (BM), 001121
 ******************************************************************************
 */
public class SsiFileNotFoundException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: SsiFileNotFoundException.java,v 1.5 2007/07/20 13:07:56 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 2517947374177387705L;
     ...
     */
    public SsiFileNotFoundException (String name)
    {
        super (name);                   // call constructor of upper class
    } // SsiFileNotFoundException
     ...
     *                  or unknown.)
     */
    public SsiFileNotFoundException (Throwable cause)
    {
     ...
     *                  or unknown.)
     */
    public SsiFileNotFoundException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // SsiFileNotFoundException

} // class SsiFileNotFoundException
