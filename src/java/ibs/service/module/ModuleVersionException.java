/*
 * Class: ModuleVersionException.java
 */
...
/******************************************************************************
 * Exception within ModuleVersion. <BR/>
 *
 * @version     $Id: ModuleVersionException.java,v 1.4 2007/07/23 12:34:23 kreimueller Exp $
 *
 * @author      Klaus, 29.12.2003
 ******************************************************************************
 */
public class ModuleVersionException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: ModuleVersionException.java,v 1.4 2007/07/23 12:34:23 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = -2718492211503971146L;
     ...
     */
    public ModuleVersionException (String name)
    {
     ...
     *                  or unknown.)
     */
    public ModuleVersionException (Throwable cause)
    {
     ...
     *                  or unknown.)
     */
    public ModuleVersionException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // ModuleVersionException
