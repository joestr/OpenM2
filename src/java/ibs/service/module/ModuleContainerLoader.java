/*
 * Class: ModuleContainerLoader.java
 */
 ...
 *
 * @version     $Id: ModuleContainerLoader.java,v 1.4 2007/07/23 12:34:23 kreimueller Exp $
 *
 * @author      Klaus, 28.12.2003
 ******************************************************************************
 */
public class ModuleContainerLoader
    extends XMLElementContainerLoader<ModuleContainer, Module>
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: ModuleContainerLoader.java,v 1.4 2007/07/23 12:34:23 kreimueller Exp $";
    ...
    /**************************************************************************
     * Creates a ModuleContainerLoader object. <BR/>
     ...
     */
    public ModuleContainerLoader (ModuleContainer container, String rootDir)
    {
        ...
        this.setTagName (ModuleConstants.TAG_MODULE);
    } // ModuleContainerLoader
     ...
     */
    protected Module parseElement (Node elemData, File dataFile)
        throws ListException
    {
        Module elem = null;
