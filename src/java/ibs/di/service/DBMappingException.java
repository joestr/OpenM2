 ...
 *
 * @version     $Id: DBMappingException.java,v 1.1 2009/08/28 14:25:16 kreimueller Exp $
 *
 * @author     Klaus Reimüller (KR), 30.07.2009
 ******************************************************************************
 */
public class DBMappingException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: DBMappingException.java,v 1.1 2009/08/28 14:25:16 kreimueller Exp $";
     ...
     */
    public DBMappingException (String name)
    {
     ...
     *                  or unknown.)
     */
    public DBMappingException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // MappingException
