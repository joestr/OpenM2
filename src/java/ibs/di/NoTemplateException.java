/*
 * Class: NoTemplateException.java
 */
 ...
 *
 * @version     $Id: NoTemplateException.java,v 1.1 2009/08/28 14:25:16 kreimueller Exp $
 *
 * @author     Klaus Reimüller (KR), 30.07.2009
 ******************************************************************************
 */
public class NoTemplateException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: NoTemplateException.java,v 1.1 2009/08/28 14:25:16 kreimueller Exp $";
     ...
     */
    public NoTemplateException (String name)
    {
     ...
     *                  or unknown.)
     */
    public NoTemplateException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // NoTemplateException
