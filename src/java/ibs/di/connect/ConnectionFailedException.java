 ...
 *
 * @version     $Id: ConnectionFailedException.java,v 1.10 2007/07/31 19:13:53 kreimueller Exp $
 *
 * @author      Bernd Buchegger (BB) 991008
 ******************************************************************************
 */
public class ConnectionFailedException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: ConnectionFailedException.java,v 1.10 2007/07/31 19:13:53 kreimueller Exp $";
     ...
     *                  or unknown.)
     */
    public ConnectionFailedException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // ConnectionFailedException
