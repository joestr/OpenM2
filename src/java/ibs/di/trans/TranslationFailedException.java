/*
 * Class: TranslationFailedException.java
 */
 ...
 *
 * @version     $Id: TranslationFailedException.java,v 1.9 2007/07/31 19:13:55 kreimueller Exp $
 *
 * @author      Bernd Buchegger (BB) 991008
 ******************************************************************************
 */
public class TranslationFailedException extends GeneralException
{
    ...
    public static final String VERSIONINFO =
        "$Id: TranslationFailedException.java,v 1.9 2007/07/31 19:13:55 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 1255218979685479904L;
     ...
     */
    public TranslationFailedException (String name)
    {
     ...
     *                  or unknown.)
     */
    public TranslationFailedException (String name, Throwable cause)
    {
