/*
 * Class: NoLayoutFoundException.java
 */
 ...
 *
 * @version     $Id: NoLayoutFoundException.java,v 1.4 2009/07/24 10:08:01 kreimueller Exp $
 *
 * @author      Klaus Reimüller (KR) 990202
 ******************************************************************************
 */
public class NoLayoutFoundException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: NoLayoutFoundException.java,v 1.4 2009/07/24 10:08:01 kreimueller Exp $";
     ...
     */
    static final long serialVersionUID = 4716276560332304756L;
     ...
     */
    public NoLayoutFoundException (String name)
    {
        super (name);                   // call constructor of upper class
    } // NoLayoutFoundException

} // class NoLayoutFoundException
