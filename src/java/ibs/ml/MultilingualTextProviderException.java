/*
 * Class: MultilingualTextProviderException
 */
 ...
 *
 * @version     $Id: MultilingualTextProviderException.java,v 1.1 2010/03/16 10:00:55 btatzmann Exp $
 *
 * @author      Bernhard Tatzmann (BT) 20100315
 ******************************************************************************
 */
public class MultilingualTextProviderException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: MultilingualTextProviderException.java,v 1.1 2010/03/16 10:00:55 btatzmann Exp $";
     ...
     */
    static final long serialVersionUID = -6654710762059519374L;
     ...
     */
    public MultilingualTextProviderException (String name)
    {
        super (name);                   // call constructor of upper class
    } // MultilingualTextProviderException
     ...
     *                  or unknown.)
     */
    public MultilingualTextProviderException (Throwable cause)
    {
     ...
     *                  or unknown.)
     */
    public MultilingualTextProviderException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // MultilingualTextProviderException
