/*
 * Class: MultilingualTextExporterException
 */
 ...
 *
 * @version     $Id: MultilingualTextExporterException.java,v 1.1 2010/04/14 14:00:38 btatzmann Exp $
 *
 * @author      Bernhard Tatzmann (BT) 20100315
 ******************************************************************************
 */
public class MultilingualTextExporterException extends GeneralException
{
    /**
    ...
    public static final String VERSIONINFO =
        "$Id: MultilingualTextExporterException.java,v 1.1 2010/04/14 14:00:38 btatzmann Exp $";
     ...
     */
    public MultilingualTextExporterException (String name)
    {
        super (name);                   // call constructor of upper class
    } // MultilingualTextExporterException
     ...
     *                  or unknown.)
     */
    public MultilingualTextExporterException (Throwable cause)
    {
     ...
     *                  or unknown.)
     */
    public MultilingualTextExporterException (String name, Throwable cause)
    {
        // call constructor of super class:
        super (name, cause);
    } // MultilingualTextExporterException
